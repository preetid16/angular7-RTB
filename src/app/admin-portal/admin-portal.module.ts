...
declarations: [ManageEmployeeComponent, TransactionManagementComponent, ItemOfDayComponent, ItemMasterListComponent, DialogOverviewExampleDialog , EditEmployeeDialog],
entryComponents: [DialogOverviewExampleDialog , EditEmployeeDialog],
})
